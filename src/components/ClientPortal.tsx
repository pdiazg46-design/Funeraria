    ...
    <div className="glass-panel w-full rounded-[1.5rem] p-3 md:p-5 relative overflow-y-auto flex flex-col max-h-[90vh] md:max-h-[85vh] custom-scrollbar">
      ...
      <div className="relative z-10 flex-grow flex flex-col justify-start md:justify-center w-full mt-2 md:mt-0">
        {step === 1 && (
          <div className="animate-in w-full">
            <div className="text-center mb-4">
              ...
              <p className="text-slate-400 text-xs font-light">Catálogo de servicios y ataúdes.</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 pb-4">
              ...
              {catalogos.map(ataud => (
                <div 
                  key={ataud.id} 
                  onClick={() => {
                     setFormData({...formData, ataudSeleccionado: ataud.id});
        ...
        {step === 3 && (
          <div className="animate-in w-full max-w-5xl mx-auto">
            <div className="text-center mb-3">
              ...
              <p className="text-slate-400 text-xs font-light">Evaluamos cobertura para descuentos previsionales.</p>
            </div>
        ...
        {step === 4 && (
          <div className="animate-in w-full max-w-5xl mx-auto">
            <div className="text-center mb-3">
              <h2 className="text-xl md:text-2xl font-serif text-white mb-0.5">Datos del Familiar Responsable</h2>
              <p className="text-slate-400 text-xs font-light">Identificación administrativa de la solicitud.</p>
            </div>
